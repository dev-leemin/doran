...
const lunchTest: TestConfig = {
  ...
  results: [
    ...
    },
    {
      ...
      title: '미식 모험가',
      emoji: '🗺️',
      icon: '/icons/lunch-adventurer.png',
